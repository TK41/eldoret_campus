...
CREATE TABLE IF NOT EXISTS fee_groups (
  ...
  academic_year VARCHAR(9) NOT NULL DEFAULT '' COMMENT 'e.g. 2024/2025',
...
ALTER TABLE fee_groups
  ADD COLUMN IF NOT EXISTS academic_year VARCHAR(9) NOT NULL DEFAULT '' COMMENT 'e.g. 2024/2025' AFTER name;

-- Seed the 4 groups from the Excel
INSERT IGNORE INTO fee_groups (group_id, name, academic_year, programme, intake, year_label, total_fees) VALUES
  (1, 'CERT MAY-INTAKE',   '2024/2025', 'certificate', 'May 2025',  'Year 1',      129000.00),
  (2, 'CERT SEPT-INTAKE',  '2025/2026', 'certificate', 'Sept 2025', 'Year 1',      129000.00),
  (3, 'DIPLOMA SECOND YR', '2025/2026', 'diploma',     NULL,        'Second Year', 201000.00),
  (4, 'DIPLOMA THIRD YR',  '2024/2026', 'diploma',     NULL,        'Third Year',  201000.00);
